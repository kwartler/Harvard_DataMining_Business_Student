...
# HOMEWORK
# 1. Describe the kpi you entered in <=3 sentences.
# 2. Pick 2 stocks and the kpi you described in #1.  Make a recommendation whether that indicator says to buy or sell and create the dashboard for each.
