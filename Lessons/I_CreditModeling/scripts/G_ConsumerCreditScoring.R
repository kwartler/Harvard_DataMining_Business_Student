...
newNotes <- read.csv('https://raw.githubusercontent.com/kwartler/Harvard_DataMining_Business_Student/master/Lessons/H_Equities_CreditModeling/data/OpenNotesJune18_v2.csv')
