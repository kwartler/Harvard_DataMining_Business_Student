...
noTextFit <- cv.glmnet(noText,
                       ...
                       nfolds=5, 
                       intercept=F)
# Fit with text and other data cbinding everything together
...
# not needed but you can transfer a tfidf weighting too: testDTMtfidf <- transform_tfidf(testDTM, idf)
