...
# I/O
df <- read.csv('https://github.com/kwartler/teaching-datasets/raw/refs/heads/main/20K_sampleLoans.csv') 

newNotes <- read.csv('https://raw.githubusercontent.com/kwartler/teaching-datasets/refs/heads/main/OpenNotesJune18_v2.csv')
