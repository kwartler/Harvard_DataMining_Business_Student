...
# I/O
df <- read.csv('https://github.com/kwartler/Harvard_DataMining_Business_Student/raw/refs/heads/master/Lessons/J_CreditModeling/data/20K_sampleLoans.csv') 

newNotes <- read.csv('https://raw.githubusercontent.com/kwartler/Harvard_DataMining_Business_Student/refs/heads/master/Lessons/J_CreditModeling/data/OpenNotesJune18_v2.csv')
