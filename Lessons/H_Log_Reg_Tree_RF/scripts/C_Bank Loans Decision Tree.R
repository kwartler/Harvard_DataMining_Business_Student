...
# saveRDS(fit,'~/Desktop/Harvard_DataMining_Business_Student/Lessons/H_Log_Reg_Tree_RF/data/fullDataTreeFit.rds')
...
# And if you need a probability outcome
testCaretProbs <- predict(fit,testDat, type = 'prob')
head(testCaretProbs) # because these are specific cut points and its the avg in the terminal node you see repeating probability values
