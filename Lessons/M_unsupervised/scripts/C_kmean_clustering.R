...
# Load
customerData <- read.csv('https://raw.githubusercontent.com/kwartler/Harvard_DataMining_Business_Student/master/Lessons/L_unsupervised/data/Cluster_Customers.csv')
