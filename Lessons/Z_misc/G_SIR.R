...
totalDays   <- 70 # Whats the timeframe in question?

# Virus Behavior
betaVal  <- 1.4247 #infection rate; how many people are infected for each person
gammaVal <- 0.14286 #recovery rate; rate an infected recovers & moves to removed; here 1/7 recover per day
...
## Checking the math with r0
#r0 = the expected number of secondary infections generated by a single, typical infection in a completely susceptible population
