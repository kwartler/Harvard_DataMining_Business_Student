...
# Read in Data
iceCream <- read_csv('https://raw.githubusercontent.com/kwartler/Harvard_DataMining_Business_Student/master/Lessons/B_IntroToDM_EDA/challenge!/mcBroken_august_12_2022.csv')

# Look at the bottom 6 rows

# Are there any NA or missings in the data?

# how many rows are there?  These are machine sensors indications
...
# get a _table_ of the unique states.  How many machines are found in each location?
...
# are there any unuaual data points that should be removed?  Subset the data to just US machines or a state of interest like MA

# Subset to just the broken machines at this specifictimeframe, then use ggplot to make another plot with the smaller data.
