...
# Data
faceDF <- read.csv("https://raw.githubusercontent.com/kwartler/Harvard_DataMining_Business_Student/master/Lessons/M_unsupervised/data/Faceplate.csv")
...
books <- read.csv('https://raw.githubusercontent.com/kwartler/Harvard_DataMining_Business_Student/master/Lessons/M_unsupervised/data/CharlesBookClub.csv')
head(books)
