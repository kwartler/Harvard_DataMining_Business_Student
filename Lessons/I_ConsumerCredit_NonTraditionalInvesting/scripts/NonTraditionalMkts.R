...
source('/cloud/project/Lessons/I_ConsumerCredit_NonTraditionalInvesting/scripts/Z_openBox.R')
source('/cloud/project/Lessons/I_ConsumerCredit_NonTraditionalInvesting/scripts/Z_crackPack.R')
source('/cloud/project/Lessons/I_ConsumerCredit_NonTraditionalInvesting/scripts/Z_cardValues.R')
...
# Plot and Review 
boxPrice <- 83 #$190 for Iconic Masters & $835 for Guilds, Throne
